# Ominode Electron Desktop App

This directory contains the Electron wrapper for Ominode, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., ominode-macos)
cp ../ominode-macos ../ominode
```
...
- Store database in `../data/ominode.db`
...
### Database Location
- **Development**: `../data/ominode.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/Ominode/data/`
  - Windows: `%APPDATA%/Ominode/data/`
  - Linux: `~/.config/Ominode/data/`
