  ...
  if (variant === 'inline') {
    return (
      <Link
        ...
        className={cn(
          'text-foreground inline-flex h-9 items-center gap-2 rounded-lg border border-primary/15 bg-primary/5 px-2 text-sm font-semibold transition-colors outline-none select-none',
