...
// Renders the legal links container on the side of a custom footer; renders
// nothing when no legal links are configured.
function CustomFooterLegalLinks() {
  const { status } = useStatus()
...
export function Footer(props: FooterProps) {
  ...
  const displayName = systemName || props.name || 'ominode'
        ...
        links: [
          {
            ...
            href: 'https://docs.ominode.com/',
          },
          {
            text: t('footer.columns.about.links.contact'),
            href: 'https://docs.ominode.com/faq',
          },
          {
            text: t('footer.columns.about.links.features'),
            href: 'https://docs.ominode.com/models',
          },
        ],
      },
      {
        ...
        links: [
          {
            ...
            href: 'https://docs.ominode.com/getting-started',
          },
          {
            text: t('footer.columns.docs.links.installation'),
            href: 'https://docs.ominode.com/billing',
          },
          {
            text: t('footer.columns.docs.links.apiDocs'),
            href: 'https://docs.ominode.com/quickstart',
          },
        ],
      },
      {
