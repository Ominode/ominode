  ...
  return (
    <section className='relative z-10 overflow-hidden px-6 py-28 md:py-44'>
      ...
      >
        ...
        <p className='landing-lede mx-auto mt-6 max-w-md text-base md:text-lg'>
          {t(
        ...
        <div className='mt-10 flex items-center justify-center gap-3'>
          ...
          <Button
            variant='outline'
            className='h-11 rounded-lg border-white/60 bg-white/70 px-6 text-(--landing-ink) backdrop-blur hover:bg-white/90 dark:border-white/20 dark:bg-white/10 dark:hover:bg-white/20'
