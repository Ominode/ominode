  ...
  return (
    <section className='relative z-10 overflow-hidden px-6 py-28 md:py-44'>
      ...
      >
        ...
        <p className='text-muted-foreground mx-auto mt-6 max-w-md text-base leading-relaxed md:text-lg'>
          {t(
        ...
        <div className='mt-10 flex items-center justify-center gap-3'>
          ...
          <Button
            variant='outline'
            className='h-11 rounded-lg border-border bg-background/70 px-6 backdrop-blur hover:bg-accent'
