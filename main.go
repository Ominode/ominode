...
import (
	...
	"github.com/chain-works/ominode/controller"
	...
	"github.com/chain-works/ominode/oauth"
	perfmetrics "github.com/chain-works/ominode/pkg/perf_metrics"
	"github.com/chain-works/ominode/relay"
	"github.com/chain-works/ominode/router"
	"github.com/chain-works/ominode/service"
	"github.com/chain-works/ominode/service/authz"
	_ "github.com/chain-works/ominode/setting/performance_setting"
...
func main() {
	...
	server.Use(gin.CustomRecovery(func(c *gin.Context, err any) {
		...
		c.JSON(http.StatusInternalServerError, gin.H{
			"error": gin.H{
				"message": fmt.Sprintf("Panic detected, error: %v. Please submit a issue here: https://github.com/chain-works/ominode", err),
				"type":    "new_api_panic",
			},
		})
	}))
